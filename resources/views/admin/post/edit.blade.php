    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <input type="text" name='title' class="form-control {{$errors->first('title') ? "is-invalid" : "" }} " value="{{old('title') ? old('title') : $post->title}}" id="title" placeholder="{{__('message.Title')}}">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <input type="text" name='keyword' class="form-control {{$errors->first('keyword') ? "is-invalid" : "" }} " value="{{old('keyword') ? old('keyword') : $post->keyword}}" id="keyword" placeholder="{{__('message.Palabra clave')}}">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <input type="text" name='meta_desc' class="form-control {{$errors->first('meta_desc') ? "is-invalid" : "" }} " value="{{old('meta_desc') ? old('meta_desc') : $post->meta_desc}}" id="meta_desc" placeholder="{{__('message.Meta Desc')}}">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <select name='status' class="form-control {{$errors->first('status') ? "is-invalid" : "" }} " id="status">
                    <option {{$post->status == 'PUBLISH' ? 'selected' : ''}} value="PUBLISH">{{__('message.PUBLISH')}}</option>

                    <option {{$post->status == 'DRAFT' ? 'selected' : ''}} value="DRAFT">{{__('message.DRAFT')}}</option>
                </select>
