    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <textarea name="descripción" class="form-control {{$errors->first('descripción') ? "is-invalid" : "" }} "  id="summernote" cols="30" rows="10">{{old('descripción') ? old('descripción') : $faq->answer}}</textarea>
                <div class="invalid-feedback">
