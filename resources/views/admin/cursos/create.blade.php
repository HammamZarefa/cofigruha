...
@section('content')
    ...
    <form action="{{ route('admin.cursos.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-groups">
                ...
                <div class="col-sm-9">
                    <select name='tipo_curso'
                        ...
                        @foreach ($tipo_curso as $tipo_curso)
                            <option
                                value="{{ $tipo_curso->id }}" {{old('tipo_curso') == $tipo_curso->id ? "selected" : ""}}>{{ $tipo_curso->tipo_curso }}</option>
                        @endforeach
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="col-sm-9">
                    @foreach($tipo_maquina as $tipo_maquina)
                        <div class="form-check">
                            <input class="form-check-input {{$errors->first('tipo_maquina') ? "is-invalid" : "" }}"
                                   name="tipo_maquina[]" type="checkbox" value="{{$tipo_maquina->id}}"
                                   id="{{$tipo_maquina->id}}" onclick="updateSearchBox();">
                    ...
                    @if(auth()->user()->perfil=='Administrador')
                        <select name='entidad' class="form-control {{$errors->first('entidad') ? "is-invalid" : "" }} "
                            ...
                            @foreach ($entidad as $entidad)
                                <option
                                    value="{{ $entidad->id }}" {{old('entidad') == $entidad->id ? "selected" : ""}}>{{ $entidad->nombre }}</option>
                            @endforeach
                        </select>
                    @else
                ...
                <div class="col-sm-9">
                    <select name='formador' class="form-control {{$errors->first('formador') ? "is-invalid" : "" }} "
                        ...
                        @foreach ($formador as $formador)
                            <option
                                value="{{ $formador->id }}" {{old('formador') == $formador->id ? "selected" : ""}}>{{ $formador->nombre }}</option>
                        @endforeach
                    </select>
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                <label for="formador_apoyo_1" class="col-sm-12 col-form-label">{{__('message.Formador Apoyo')}}
                    1</label>
                <div class="col-sm-9">
                    <select name='formador_apoyo_1'
                            class="form-control {{$errors->first('formador_apoyo_1') ? "is-invalid" : "" }} "
                            id="formador_apoyo1">
                        <option disabled selected>{{__('message.Choose_One')}}</option>
                        @foreach ($formadors as $formadors)
                            <option
                                value="{{ $formadors->id }}" {{old('formador_apoyo_1') == $formadors->id ? "selected" : ""}}>{{ $formadors->nombre }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <label for="formador_apoyo_2" class="col-sm-12 col-form-label">{{__('message.Formador Apoyo')}}
                    2</label>
                <div class="col-sm-9">
                    <select name='formador_apoyo_2'
                            class="form-control {{$errors->first('formador_apoyo2') ? "is-invalid" : "" }} "
                            id="formador_apoyo2">
                        <option disabled selected>{{__('message.Choose_One')}}</option>
                        @foreach ($formadors2 as $formador)
                            <option
                                value="{{ $formador->id }}" {{old('formador_apoyo_2') == $formador->id ? "selected" : ""}}>{{ $formador->nombre }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-md-4">
                <label for="formador_apoyo_3" class="col-sm-12 col-form-label">{{__('message.Formador Apoyo')}}
                    3</label>
                <div class="col-sm-9">
                    <select name='formador_apoyo_3'
                            class="form-control {{$errors->first('formador_apoyo3') ? "is-invalid" : "" }} "
                            id="formador_apoyo3">
                        <option disabled selected>{{__('message.Choose_One')}}</option>
                        @foreach ($formadors3 as $formador)
                            <option
                                value="{{ $formador->id }}" {{old('formador_apoyo_3') == $formador->id ? "selected" : ""}}>{{ $formador->nombre }}</option>
                        @endforeach
                    </select>
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="datetime-local" name='fecha_inicio'
                           ...
                           value="{{old('fecha_inicio')}}" id="fecha_inicio">
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="text" name='ciudad'
                           ...
                           value="{{old('ciudad')}}" id="ciudad" placeholder="Ciudad del curso">
                    <div class="invalid-feedback">
                        {{ $errors->first('ciudad') }}
                    </div>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="text" name='provincia'
                           ...
                           value="{{old('provincia')}}" id="provincia" placeholder="Provincia del curso">
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="number" name='codigo_postal'
                           ...
                           value="{{old('codigo_postal')}}" id="codigo_postal" placeholder="Código postal del curso">
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="file" name='asistentes_pdf'
                           ...
                           value="{{old('asistentes_pdf')}}" id="asistentes_pdf" placeholder="asistentes_pdf">
                    <div class="invalid-feedback">
                    ...
                    <div class="col-sm-9">
                        <select name='examen_t'
                            ...
                            @foreach ($examen_t as $examen_t)
                                <option
                                    value="{{ $examen_t->id }}" {{old('examen_t') == $examen_t->id ? "selected" : ""}}>{{ $examen_t->nombre }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-9">
                        <select name='examen_p'
                            ...
                            @foreach ($examen_p as $examen_p)
                                <option
                                    value="{{ $examen_p->id }}" {{old('examen_p') == $examen_p->id ? "selected" : ""}}>{{ $examen_p->nombre }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="text" name='observaciones'
                           ...
                           value="{{old('observaciones')}}" id="observaciones" placeholder="Observaciones al curso">
                    <div class="invalid-feedback">
...
@push('scripts')
    ...
    <script>
        var aCheckBox = document.getElementById('1');
        var bCheckBox = document.getElementById('2');
        var cCheckBox = document.getElementById('3');
