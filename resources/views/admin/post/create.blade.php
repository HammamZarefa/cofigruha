            ...
            <div class="form-group ml-5">
                ...
                <div class="col-sm-9">
                    <input type="text" name='title'
                           ...
                           value="{{old('title')}}" id="title" placeholder="{{__('message.Title')}}">
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
                </div>
            ...
            <div class="form-group ml-5">
                ...
                <div class="col-sm-9">
                    <textarea name="body" class="form-control {{$errors->first('body') ? "is-invalid" : "" }} "
                              id="summernote" cols="30" rows="10">{{old('body')}}</textarea>
                    <div class="invalid-feedback">
                        {{ $errors->first('body') }}
                    </div>
                </div>
            ...
            <div class="form-group ml-5">
                ...
                <div class="col-sm-9">
                    <input type="text" name='keyword'
                           ...
                           value="{{old('keyword')}}" id="keyword" placeholder="{{__('message.Palabra clave')}}">
            ...
            <div class="form-group ml-5">
                ...
                <div class="col-sm-9">
                    <input type="text" name='meta_desc'
                           ...
                           value="{{old('meta_desc')}}" id="meta_desc" placeholder="{{__('message.Meta Desc')}}">
                    <div class="invalid-feedback">
